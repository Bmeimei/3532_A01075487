...
class BookAnalyzer:
    ...
    def is_unique(word, word_list):
        ...
        This function is also slow because it would convert both word and words in the word_list into lower case,
        and compare them. So to improve it, cancel in-sensitive, leave it to other part. It should convert the word
        into lower case before calling this function.
    ...
    def find_unique_words(self):
        ...
        This function costs most of the time. Call is_unique() costs 98% of the time.
        ...
        while temp_text:
            # word = temp_text.pop()
            # Convert the word into lower case before calling is_unique.
            word = temp_text.pop().lower()

            # if self.is_unique(word, temp_text):
            # Compares the word in the unique words list
            if self.is_unique(word, unique_words):
